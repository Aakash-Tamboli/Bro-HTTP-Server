...
*/
Bulb *g; // Pointer
g=new Bulb; // allocation memory on heap
g->setWattage(60); // setting wattage 60 for where g is pointing to an object
c.set("philips",g); // we are kept reference of object
g->setWattage(100);
delete g; // application might be crashed or un predictable output 
} // g will be die(conceptually) but object is still in heap section
