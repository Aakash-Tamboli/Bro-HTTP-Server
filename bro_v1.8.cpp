...
bro.get("/whoIsGreat",[](Request &request,Response &response,ApplicationLevelContainer &applicationLevelContainer){
string *str;
str=new string("God is Great");
applicationLevelContainer.set("whoIsGreat",str,NULL,NULL);
response.setContentType("text/html");
response<<R""""(
<!DOCTYPE HTML>
<html lang='en'>
<head>
<meta charset='utf-8'>
<title>The Biggest Question Who</title>
</head>
<body>
<h1>No Doubt!! God is Great</h1>
<a href='/whoIsAlwaysGreat'>Still Doubt</a>
</body>
</html>
)"""";
});

bro.get("/whoIsAlwaysGreat",[](Request &request,Response &response,ApplicationLevelContainer &applicationLevelContainer){
string *p;
applicationLevelContainer.remove("whoIsGreat",&p,NULL,NULL);
response.setContentType("text/html");
response<<R""""(
<!DOCTYPE HTML>
<html lang='en'>
...
<body>
<h1>Again No Doubt!! In the begining
)"""";
response<<*p;
response<<R""""(
</h1>
