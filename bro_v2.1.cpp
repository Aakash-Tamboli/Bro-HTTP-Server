...
return false; // just for temporary
}
...
string folderName=string("bro_private")+string(PATH_SEPRATOR)+string("vmdFiles");
...
if(createVMDFile)
{
createVMDFileAndProcessCHTMLFile(chtmlFileName,pathToVMDFile.c_str());
}
else
{
